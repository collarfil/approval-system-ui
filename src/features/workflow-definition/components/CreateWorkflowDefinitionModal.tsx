...
import {
    ...
    type WorkflowDefinitionFormData,
} from "../schemas/workflowDefinitionSchema";
...
export default function CreateWorkflowDefinitionModal({
    open,
    onClose,
}: Props) {
    ...
    const onSubmit = (
        data: WorkflowDefinitionFormData
    ) => {
